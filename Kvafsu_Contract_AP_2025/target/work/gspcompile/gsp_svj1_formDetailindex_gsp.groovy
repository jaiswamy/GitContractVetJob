...
class gsp_svj1_formDetailindex_gsp extends GroovyPage {
...
printHtmlPart(116)
createClosureForHtmlPart(140, 4)
invokeTag('form','g',1579,['url':([resource:formDetailInstance, action:'delete']),'method':("DELETE")],4)
printHtmlPart(116)
}
else {
printHtmlPart(9)
createClosureForHtmlPart(141, 4)
invokeTag('link','g',1588,['class':("btn btn blue btn-primary"),'action':("show"),'resource':(formDetailInstance)],4)
printHtmlPart(142)
}
printHtmlPart(194)
i++
...
if(true && (formDetailInstance?.paymentInfoId?.status != "success")) {
printHtmlPart(116)
createClosureForHtmlPart(240, 4)
invokeTag('form','g',1936,['url':([resource:formDetailInstance, action:'delete']),'method':("DELETE")],4)
printHtmlPart(116)
}
else {
printHtmlPart(9)
createClosureForHtmlPart(141, 4)
invokeTag('link','g',1939,['class':("btn btn blue btn-primary"),'action':("show"),'resource':(formDetailInstance)],4)
printHtmlPart(142)
}
printHtmlPart(194)
i++
...
expressionOut.print(formDetailInstance?.gender)
printHtmlPart(251)
invokeTag('formatDate','g',2014,['date':(formDetailInstance.dob),'format':("mm-dd-yyyy")],-1)
printHtmlPart(252)
expressionOut.print(formDetailInstance?.email)
printHtmlPart(253)
expressionOut.print(formDetailInstance?.phoneNumber)
...
expressionOut.print(formDetailInstance?.kvcNo)
printHtmlPart(266)
invokeTag('formatDate','g',2065,['date':(formDetailInstance.fvcDate),'format':("dd-MM-yyyy")],-1)
printHtmlPart(267)
expressionOut.print(formDetailInstance?.neteducation)
printHtmlPart(268)
expressionOut.print(formDetailInstance?.age)
...
expressionOut.print(formDetailInstance?.j371)
printHtmlPart(277)
invokeTag('formatDate','g',2152,['date':(formDetailInstance.hkIssueDate),'format':("dd-MM-yyyy")],-1)
printHtmlPart(278)
expressionOut.print(formDetailInstance?.hkRDNO)
printHtmlPart(279)
expressionOut.print(formDetailInstance?.sslc)
...
expressionOut.print(formDetailInstance?.percentagesslc)
printHtmlPart(101)
invokeTag('formatDate','g',2204,['date':(formDetailInstance.sslcyear),'format':("dd-MM-yyyy")],-1)
printHtmlPart(102)
expressionOut.print(formDetailInstance?.boardUniversitysslc)
printHtmlPart(280)
expressionOut.print(formDetailInstance?.kannadaLanguage)
...
expressionOut.print(formDetailInstance?.percentagepuc)
printHtmlPart(104)
invokeTag('formatDate','g',2284,['date':(formDetailInstance.pucyear),'format':("dd-MM-yyyy")],-1)
printHtmlPart(102)
expressionOut.print(formDetailInstance?.boardUniversitypuc)
printHtmlPart(107)
expressionOut.print(formDetailInstance?.degreeNameBachelors)
...
expressionOut.print(formDetailInstance?.percentagebachelorsDegree)
printHtmlPart(110)
invokeTag('formatDate','g',2328,['date':(formDetailInstance.bachelorsDegreeyear),'format':("dd-MM-yyyy")],-1)
printHtmlPart(111)
expressionOut.print(formDetailInstance?.boardUniversitybachelorsDegree)
printHtmlPart(112)
if(true && (formDetailInstance?.mastersDegree != "")) {
...
if(true && (formDetailInstance.mastersDegreeyear != null)) {
printHtmlPart(120)
invokeTag('formatDate','g',2390,['date':(formDetailInstance.mastersDegreeyear),'format':("dd-MM-yyyy")],-1)
printHtmlPart(121)
}
printHtmlPart(118)
if(true && (formDetailInstance?.boardUniversitymastersDegree != "")) {
...
if(true && (formDetailInstance.pHDyear != null)) {
printHtmlPart(120)
invokeTag('formatDate','g',2451,['date':(formDetailInstance.pHDyear),'format':("dd-MM-yyyy")],-1)
printHtmlPart(121)
}
printHtmlPart(118)
if(true && (formDetailInstance?.boardUniversitypHD != "")) {
...
createTagBody(5, {->
printHtmlPart(300)
invokeTag('message','g',3398,['code':("default.button.Pay Now.label"),'default':("Pay Now")],-1)
printHtmlPart(228)
})
invokeTag('link','g',3398,['class':("btn yellow"),'action':("makePayment"),'resource':(formDetailInstance)],5)
printHtmlPart(305)
})
invokeTag('form','g',3399,['url':([resource:formDetailInstance, action:'delete']),'method':("DELETE")],4)
printHtmlPart(116)
}
else {
printHtmlPart(9)
createClosureForHtmlPart(141, 4)
invokeTag('link','g',3401,['class':("btn btn blue btn-primary"),'action':("show"),'resource':(formDetailInstance)],4)
printHtmlPart(142)
}
printHtmlPart(194)
i++
...
invokeTag('captureBody','sitemesh',3486,['class':("page-container-bg-solid")],1)
printHtmlPart(307)
}
...
public static final long LAST_MODIFIED = 1677906070000L
