...
class gsp_convetjob_formDetailshow_gsp extends GroovyPage {
...
printHtmlPart(183)
createClosureForHtmlPart(184, 3)
invokeTag('form','g',1485,['url':([resource:formDetailInstance, action:'delete']),'method':("DELETE")],3)
printHtmlPart(185)
}
else {
printHtmlPart(186)
...
invokeTag('captureBody','sitemesh',1561,['class':("page-container-bg-solid"),'id':("printableArea")],1)
printHtmlPart(188)
}
...
public static final long LAST_MODIFIED = 1749523162467L
