...
class gsp_convetjob_formDetail_educationform_gsp extends GroovyPage {
...
printHtmlPart(44)
invokeTag('hiddenField','g',793,['name':("reportId"),'value':(formDetailInstance?.id)],-1)
printHtmlPart(45)
invokeTag('actionSubmit','g',795,['class':("btn yellow"),'id':("add_field_button1"),'value':("Add More")],-1)
printHtmlPart(46)
}
...
public static final long LAST_MODIFIED = 1749511178568L
