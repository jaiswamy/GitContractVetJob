...
class gsp_convetjob_superadminindex_gsp extends GroovyPage {
...
invokeTag('formRemote','g',135,['name':("kk"),'url':([action:'createadmin']),'update':("update1"),'class':("horizontal-form")],3)
printHtmlPart(14)
loop:{
int i = 0
...
createTagBody(4, {->
printHtmlPart(25)
invokeTag('hiddenField','g',207,['name':("userListid"),'value':(usersInstance?.id)],-1)
printHtmlPart(26)
invokeTag('submitButton','g',210,['name':("Edit"),'class':("btn btn-primary")],-1)
printHtmlPart(27)
})
invokeTag('formRemote','g',212,['name':("kk"),'url':([action:'adminEdit']),'update':("update1")],4)
printHtmlPart(28)
i++
}
}
...
invokeTag('ifAnyGranted','sec',222,['roles':("ROLE_SUPERADMIN")],2)
printHtmlPart(30)
invokeTag('render','g',245,['template':("/header/footer")],-1)
printHtmlPart(31)
})
invokeTag('captureBody','sitemesh',307,['class':("page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid")],1)
printHtmlPart(32)
}
...
public static final long LAST_MODIFIED = 1675768534000L
