...
class gsp_convetjob_formDetailcreate_gsp extends GroovyPage {
...
invokeTag('captureBody','sitemesh',1250,['class':("page-container-bg-solid"),'onload':("noBack();"),'onpageshow':("if (event.persisted) noBack();"),'onunload':("")],1)
printHtmlPart(49)
}
...
public static final long LAST_MODIFIED = 1749504315685L
