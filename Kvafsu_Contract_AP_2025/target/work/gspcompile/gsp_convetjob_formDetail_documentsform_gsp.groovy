...
class gsp_convetjob_formDetail_documentsform_gsp extends GroovyPage {
...
printHtmlPart(19)
if(true && (formdt?.ageRelax == "Yes")) {
printHtmlPart(20)
}
printHtmlPart(21)
if(true && (formdt?.kvcNo)) {
printHtmlPart(22)
}
printHtmlPart(23)
loop:{
...
public static final long LAST_MODIFIED = 1749521250838L
