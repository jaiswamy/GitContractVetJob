...
class gsp_convetjob_usercreate_userFORM_gsp extends GroovyPage {
...
printHtmlPart(21)
invokeTag('actionSubmit','g',115,['action':("saveUser"),'class':("btn btn-primary"),'value':("Save Details")],-1)
printHtmlPart(22)
}
else {
printHtmlPart(23)
invokeTag('hiddenField','g',118,['name':("userListid"),'value':(usersInstance?.id)],-1)
printHtmlPart(24)
invokeTag('actionSubmit','g',120,['action':("updateUser"),'class':("btn btn-primary"),'value':("Update Details")],-1)
printHtmlPart(22)
}
printHtmlPart(25)
})
invokeTag('form','g',121,['controller':("usercreate"),'enctype':("multipart/form-data"),'name':("validateip"),'class':("horizontal-form")],1)
printHtmlPart(26)
}
...
public static final long LAST_MODIFIED = 1675768562000L
