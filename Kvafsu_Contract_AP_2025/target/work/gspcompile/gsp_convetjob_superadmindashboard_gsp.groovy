...
class gsp_convetjob_superadmindashboard_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(5)
invokeTag('render','g',539,['template':("/header/topBar")],-1)
printHtmlPart(6)
createClosureForHtmlPart(7, 2)
invokeTag('link','g',549,['controller':("formDetail"),'action':("create")],2)
printHtmlPart(8)
createClosureForHtmlPart(9, 2)
invokeTag('link','g',555,['controller':("formDetail"),'action':("index")],2)
printHtmlPart(10)
})
invokeTag('captureBody','sitemesh',702,['class':("page-container-bg-solid")],1)
printHtmlPart(11)
}
...
public static final long LAST_MODIFIED = 1749513443036L
