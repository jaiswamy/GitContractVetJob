...
class gsp_convetjob_usercreateindex_gsp extends GroovyPage {
...
printHtmlPart(7)
invokeTag('render','g',97,['template':("/header/leftSide"),'model':([activ:[adminssion:'start active open']])],-1)
printHtmlPart(8)
...
invokeTag('formRemote','g',148,['name':("kk"),'url':([action:'createUser']),'update':("update1"),'class':("horizontal-form")],3)
printHtmlPart(14)
loop:{
int i = 0
...
invokeTag('ifAnyGranted','sec',233,['roles':("ROLE_ADMIN")],2)
printHtmlPart(30)
...
public static final long LAST_MODIFIED = 1675768566000L
