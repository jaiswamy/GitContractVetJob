...
class gsp_convetjob_formDetailcreateEducations_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/formDetail/createEducations.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',226,['controller':("superadmin"),'action':("dashboard")],2)
printHtmlPart(8)
invokeTag('render','g',231,['template':("/header/topBar")],-1)
printHtmlPart(9)
createTagBody(2, {->
printHtmlPart(10)
invokeTag('render','g',241,['template':("educationform")],-1)
printHtmlPart(11)
invokeTag('submitButton','g',253,['name':("create"),'class':("btn green"),'style':("margin-left:250px"),'value':(message(code: 'default.button.Submit.label', default: 'Save & Continue')),'id':("techingva1"),'data-toggle':("modal"),'data-target':("#exampleModalLong"),'onclick':("return confirm('Please verify all the details before saving, Once Saved details can not be edited.')")],-1)
printHtmlPart(12)
})
invokeTag('form','g',254,['url':([resource:formDetailInstance, action:'educationDetails']),'class':("form-horizontal"),'enctype':("multipart/form-data"),'id':("teach")],2)
printHtmlPart(13)
...
invokeTag('captureBody','sitemesh',1049,['class':("page-container-bg-solid"),'onload':("noBack();"),'onpageshow':("if (event.persisted) noBack();"),'onunload':("")],1)
printHtmlPart(49)
}
...
public static final long LAST_MODIFIED = 1677302620000L
