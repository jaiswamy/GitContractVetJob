...
class gsp_svj1_formDetailcreatedocumentss_gsp extends GroovyPage {
...
invokeTag('captureBody','sitemesh',936,['class':("page-container-bg-solid"),'onload':("noBack();"),'onpageshow':("if (event.persisted) noBack();"),'onunload':("")],1)
printHtmlPart(14)
}
...
public static final long LAST_MODIFIED = 1677302608000L
