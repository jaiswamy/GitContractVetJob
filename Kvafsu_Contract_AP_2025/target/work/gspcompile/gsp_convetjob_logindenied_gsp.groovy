...
class gsp_convetjob_logindenied_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('message','g',9,['code':("springSecurity.denied.message")],-1)
printHtmlPart(3)
})
...
public static final long LAST_MODIFIED = 1675768498000L
