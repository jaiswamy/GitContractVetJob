...
class gsp_convetjob_formDetailcreatedocumentss_gsp extends GroovyPage {
...
invokeTag('captureBody','sitemesh',408,['class':("page-container-bg-solid"),'onload':("noBack();"),'onpageshow':("if (event.persisted) noBack();"),'onunload':("")],1)
printHtmlPart(14)
}
...
public static final long LAST_MODIFIED = 1749521811455L
