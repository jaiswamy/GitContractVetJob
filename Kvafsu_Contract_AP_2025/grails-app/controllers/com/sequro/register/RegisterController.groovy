...
class RegisterController {
	...
	def createUser(SecUser secUserInstance){
		...
		String Emailverificationurl = generateLink('emailverify', [id: secUserInstance])
		emailService.sendRegSuccessEmail(params.username,params.email, "Registration Success!",Emailverificationurl,"/testmail/registration_successs")
