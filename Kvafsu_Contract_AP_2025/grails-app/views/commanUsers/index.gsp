...
<meta content="KVAFSU" name="description" />
...
<link href="assets1/layouts/layout4/css/custom.min.css" rel="stylesheet"
	type="text/css" />
<link href="assets1/layouts/layout4/css/themes/default.min.css"
								...
								<div class="portlet-body form">
									...
									<g:formRemote name="kk" url="[action:'createadmin']"
										update="update1" class="horizontal-form">
											...
											<i class="fa fa-plus"></i> &nbsp;&nbsp;Create CommanUsers
										</button>
									</g:formRemote>
												...
												<div class="portlet-title">
													<div class="caption font-red">
														<i class="icon-settings font-red"></i> <span
															class="caption-subject bold uppercase">Create List</span>
													</div>
													<div class="tools"></div>
												</div>
