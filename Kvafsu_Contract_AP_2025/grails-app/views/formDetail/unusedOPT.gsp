																...
																<div>
																	<div class="portlet-title">
																		<div class="caption font-red">
																			<i class="icon-user font-red"></i> <span
																				class="caption-subject bold uppercase">UnUsed
																				OPT Folder List </span>
																		</div>
																		<div class="tools"></div>
																	</div>
																	<div class="portlet-body ">
																			...
																			<tbody>
																				<g:each in="${formdet}" status="i"
																					...
																					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
																						...
																						<td>
																							${fieldValue(bean: formDetailInstance, field: "apllicationNo")}
																		...
																		<td><g:formRemote name="kk"
																				style="text-align:center" url="[action:'adminEdit']"
																				update="update1">
																				...
																				<sec:ifAnyGranted roles="ROLE_ADMIN">
																					<g:link
																						class="btn btn-transparent yellow btn-outline btn-circle btn-sm active"
																						action="deleteOPT"
																						resource="${formDetailInstance}">
																						<g:message code="default.button.All Delete.label"
																							default="All Delete" />
																					</g:link>
																				</sec:ifAnyGranted>
