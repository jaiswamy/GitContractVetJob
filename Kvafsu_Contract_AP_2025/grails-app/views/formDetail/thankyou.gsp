													...
													<div class=content>
														<div class="wrapper-1">
															<div class="wrapper-2">
																...
																<p style="color: green">
																	Note:Please login again and check your application
																	status.
																</p>
																<div id="wrap">
																	<%--<div> 
  ...
  --%>
															...
															<div class="footer-like">
																<sec:ifAnyGranted roles="ROLE_ADMIN">
																	<p>
																		...
																		<g:link class="btn btn-primary"
																			controller="formDetail" action="adminformDetails"
																...
																<sec:ifAnyGranted roles="ROLE_COMMANUSERS">
																	<p>
																		Home Page
																		<g:link class="btn green" controller="formDetail"
																			action="index" resource="${formDetailInstance}">
																			<g:message code="default.button.Click here.label"
																				default="Click here" />
																		</g:link>
																</sec:ifAnyGranted>
