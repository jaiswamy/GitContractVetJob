...
-webkit-keyframes glowing { 0% {
	...
	-webkit-box-shadow: 0 0 3px #389121;
}
...
@
-webkit-keyframes glowing1 { 0% {
	background-color: #7e69d4;
	-webkit-box-shadow: 0 0 3px #7e69d4;
}
...
@
-moz-keyframes glowing1 { 0% {
	background-color: #7e69d4;
	-moz-box-shadow: 0 0 3px #7e69d4;
}
...
@
-o-keyframes glowing1 { 0% {
	background-color: #7e69d4;
	box-shadow: 0 0 3px #7e69d4;
}
...
<body class="page-container-bg-solid">
										...
										<div class="col-md-12">
											...
											<div class="portlet light bordered">
												...
												<div class="portlet-body form" style="text-align: center;">
													...
													<h1
														class="form-section caption-subject font-red bold uppercase"
														style="TEXT-ALIGN: center !important;">Application For Assistant Professor on Contract Basis</h1>

													<g:link controller="formDetail" action="create">
														<button type="submit" class="button1"
															style="TEXT-ALIGN: center !important;">Teaching
															Post</button>
													</g:link>
													<g:link controller="formDetail" action="index">
														<button type="submit" class="list2"
															style="TEXT-ALIGN: center !important;">Teaching
	...
	<div class="container">
		<h2>Contact Email:kvafsvjobs@gmail.com</h2>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<img src="assets1/layouts/layout3/img/preview.gif" height="250px"
							width="50%" style="margin-left: 150px;">
						<p
							style="font-size: 25px; color: red; text-align: left; text-align: justify;">
							<b>Note:</b><br />*Please verify all the details before
							submitting, after submitting there is No Update/ Edit option.<br />
						</p>
