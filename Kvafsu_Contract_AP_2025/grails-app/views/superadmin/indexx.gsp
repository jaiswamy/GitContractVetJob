											...
											<div class="portlet light bordered">
												...
												<div class="portlet-title">
																...
																<div class="dropdown">
																	...
																	<div id="myDropdown" class="dropdown-content">
																		<sec:ifAnyGranted roles="ROLE_ADMIN">
																			<g:link controller="formDetail" action="userlist">
																				<span>User List</span>
																				<br>
																			</g:link>

																			<g:link controller="formDetail" action="unusedOPT">
																				<span>Delete OPT Folder(Un paid)</span>
																				<br>
																			</g:link>
													...
													<div class="user-menu dropdown-menu"
														style="background-color: #dce1fa; margin-top: 2px;">
												...
												<div class="portlet-body form" style="text-align: center;">
													...
													<h1
														...
														style="TEXT-ALIGN: center !important;">List of all
														the Applications</h1>



													<g:link controller="formDetail" action="adminformDetails">
														<button type="submit" class="button1" style=" border:2px solid black"
															style="TEXT-ALIGN: center !important;">View
															Contract Teaching Post List</button>
													</g:link>
	...
	<div class="page-wrapper-row">
		<div class="page-wrapper-bottom">
			...
			<div class="page-footer">
				<div class="container">
					2025 &copy; <a target="_blank" href="http://hiideals.com">Hiideals</a>
				</div>
			</div>
